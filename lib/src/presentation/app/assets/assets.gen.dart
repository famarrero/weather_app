...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/isotype_weather_app.png
  AssetGenImage get isotypeWeatherApp =>
      const AssetGenImage('assets/images/isotype_weather_app.png');

  /// List of all assets
  List<AssetGenImage> get values => [isotypeWeatherApp];
}
